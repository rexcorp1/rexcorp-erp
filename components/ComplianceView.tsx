                ...
                <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <form onSubmit={saveDocForm} className="space-y-6">
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            <div>
                                ...
                                <select 
                                    ...
                                    required
                                >
                                    <option value="PEB">Pemberitahuan Ekspor Barang (PEB)</option>
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <option value="Sent">Sent / APPD</option>
                                    <option value="Jalur Hijau">Jalur Hijau (Automatic Release)</option>
                                    <option value="Jalur Kuning">Jalur Kuning (Document Verification Required)</option>
                                    <option value="Jalur Merah">Jalur Merah (Physical Examination Required)</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-3 justify-end border-t pt-4 dark:border-gray-700">
                            <button 
                                type="button"
                                onClick={() => { setIsCreatingDoc(false); setIsEditingDoc(false); }}
        ...
        return (
            <div className="space-y-6">
                <div className="flex justify-between items-center flex-wrap gap-4 bg-white p-4 rounded-lg border shadow-sm dark:bg-gray-800 dark:border-gray-700">
                    <div>
                        <h2 className="text-lg font-bold font-mono text-gray-900 dark:text-gray-50">Declarations List (PIB / PEB Tracker)</h2>
                                    ...
                                    <tr key={doc.id} className="hover:bg-gray-50 dark:hover:bg-gray-705">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-right text-xs font-mono font-medium">
                                            <div className="flex justify-end gap-2">
                                                <button 
                                                    onClick={() => openEditDocForm(doc)}
                                                    className="inline-flex items-center p-1.5 border border-gray-200 hover:border-gray-400 hover:bg-gray-50 rounded text-gray-600 dark:border-gray-700 dark:hover:bg-gray-700 dark:text-gray-400"
                                                    title="Edit Document"
                                                >
                                                ...
                                                <button 
                                                    ...
                                                    className="inline-flex items-center p-1.5 border border-red-200 hover:bg-red-50 text-red-600 rounded dark:border-gray-700 dark:hover:bg-red-950/30"
